...
function App() {
  ...
  const cadenaReproducir = () => {
    var cadena =
      filtroTareas.length > 0
        ? `Para el ${fechaEspañol} tiene `
        : `Para el ${fechaEspañol} no tiene nada `;
    ...
    <div>
      ...
      <div className="columna1">
        ...
        <div className="bloque-botonera">
          ...
          <i
            className={
              formularioTareas ? "bi bi-x-lg icono" : "bi bi-plus-lg icono"
            }
            onClick={() => {
              mostrarFormularioTareas(!formularioTareas);
            }}
          />
        </div>
      </div>
